...
public class LiveSightGuidanceActivity extends Activity {
    ...
    private LiveMapRasterTileSource tileSource=null;
    ...
    private void onMapFragmentInitializationCompleted() {
        ...
        map.setCenter(new GeoCoordinate(24.839770, 55.174134, 0.0), Map.Animation.NONE);
    ...
    public void goHome(View view) {
        if (map != null) {
            ...
            Toast.makeText(LiveSightGuidanceActivity.this,tileSource.getTileSize() +"", Toast.LENGTH_LONG).show();
            ...
            if (schemes.get(total - 1).equals(current))
                ...
                for (int count = 0; count < total - 1; count++) {
                    if (schemes.get(count).equals(current)) {
                        ...
                        Toast.makeText(LiveSightGuidanceActivity.this, "Scheme name is :- " + schemes.get(count + 1), Toast.LENGTH_LONG).show();
                    }
                    }
            }
        }
    ...
    public class LiveMapRasterTileSource extends UrlMapRasterTileSourceBase {
        ...
        private final static String URL_FORMAT =
                "http://www.makani.ae/arcgis/rest/services/SampleCarto/MapServer";
